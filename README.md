...
**애플 디벨로퍼 아카데미 포항**에서 만든 프로토타입 이후
**2025-08-09** ~ **2025-09-12** 완성 된 서비스입니다.
...
- **사운드 인식**: 주변 노래를 실시간 인식해 곡 찾기 (ShazamKit 기반)
...
- **External APIs** — 노래방 기기 곡번호 데이터 파싱
